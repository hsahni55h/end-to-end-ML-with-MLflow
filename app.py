from flask import Flask, render_template, request  # Import Flask for creating the web app
import os  # Import os for operating system functionalities
import numpy as np  # Import numpy for numerical operations
import pandas as pd  # Import pandas for data manipulation
from mlProject.pipeline.prediction import PredictionPipeline  # Import the PredictionPipeline class

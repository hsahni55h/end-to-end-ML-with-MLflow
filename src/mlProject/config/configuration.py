...
class ConfigurationManager:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        ...
        )  # Get the data ingestion configuration section
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        ...
        )  # Get the data validation configuration section
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        ...
        """
        config = (
            self.config.data_transformation
        )  # Get the data transformation configuration section
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        ...
        """
        config = (
            self.config.model_trainer
        )  # Get the model trainer configuration section
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        )  # Get the model evaluation configuration section
        params = self.params.ElasticNet  # Get the ElasticNet parameters
        schema = self.schema.TARGET_COLUMN  # Get the target column from the schema
